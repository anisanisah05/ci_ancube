            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/3.png"></span>
                                <span class="subject">
                                <span class="from">Dana mayak</span>
                                <span class="time">Just now</span>
                                </span>
                                <span class="message">
                                    Ohh yang luke luke itu a
                                </span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/1.png"></span>
                                <span class="subject">
                                <span class="from">Justin Bieber</span>
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/3.png"></span>
                                <span class="subject">
                                <span class="from">Jungkook</span>
                                <span class="time">2 days ago</span>
                                </span>
                                <span class="message">
                                  saranghaeyo chagiyaa
                                </span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/2.png"></span>
                                <span class="subject">
                                <span class="from">iqbaal dhiafakri</span>
                                <span class="time">2 hour ago</span>
                                </span>
                                <span class="message">
                                  hello there, are you doing fine? <3
                                </span>
                    </a>
                </li>
                <li>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img style="width: 40px; height: 40px;"alt="" src="<?= base_url()?>assets/aa.jpg">
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a class="active" href="<?= base_url()?>index.php/galleryc/index">
                        <i class="fa fa-picture-o"></i>
                        <span>Gallery</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="<?= base_url()?>index.php/eventc/index">
